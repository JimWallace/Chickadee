...
@Suite(.serialized, .timeLimit(.minutes(3))) struct NotebookCheckRendererRExecutionTests {
    ...
    @Test(.requiresRscript) func dataFrameShapeChecksRowsAndColumns() async throws {
        let check = NotebookCheck(
            id: "shape1", kind: .dataFrameShape, tier: .pub, points: 1,
            variable: "patients", expectedRows: 3, expectedCols: 2)
    ...
    @Test(.requiresRscript) func dataFrameShapeAcceptsAnInheritingClass() async throws {
        let check = NotebookCheck(
            id: "shape1", kind: .dataFrameShape, tier: .pub, points: 1,
            variable: "patients", expectedRows: 3, expectedCols: 2)
    ...
    @Test(.requiresRscript) func dataFrameColumnsExactAndSuperset() async throws {
    ...
    @Test(.requiresRscript) func dataFrameEqualityComparesValuesWithinTolerance() async throws {
        let check = NotebookCheck(
            id: "eq1", kind: .dataFrameEquality, tier: .pub, points: 1,
    ...
    @Test(.requiresRscript) func dataFrameEqualityComparesTextColumnsAsText() async throws {
        let check = NotebookCheck(
    ...
    @Test(.requiresRscript) func seriesEqualityAcceptsVectorAndOneColumnFrame() async throws {
        let check = NotebookCheck(
    ...
    @Test(.requiresRscript) func unsupportedKindFailsClosedAtGradingTime() async throws {
        let check = NotebookCheck(
            id: "ast1", kind: .astStructure, tier: .pub, points: 1,
            requiredConstructs: ["for_loop"])
    ...
    @Test(.requiresRscript) func variableExistsChecksPresenceAndType() async throws {
    ...
    @Test(.requiresRscript) func variableExistsSeesAValueBuiltByTopLevelCalls() async throws {
        let check = NotebookCheck(
    ...
    @Test(.requiresRscript) func functionExistsChecksDefinitionAndCallability() async throws {
        let check = NotebookCheck(
    ...
    @Test(.requiresRscript) func functionExistsChecksArity() async throws {
        let check = NotebookCheck(
    ...
    @Test(.requiresRscript) func numericArrayCloseComparesWithinTolerance() async throws {
        let check = NotebookCheck(
    ...
    @Test(.requiresRscript) func numericArrayCloseTreatsMatchingNaNAndInfAsEqual() async throws {
        let check = NotebookCheck(
    ...
    @Test(.requiresRscript) func cellContainsMatchesLiteralText() async throws {
        let check = NotebookCheck(
    ...
    @Test(.requiresRscript) func cellContainsMatchesARegularExpression() async throws {
        let check = NotebookCheck(
    ...
    @Test(.requiresRscript) func cellContainsRejectsACopyOfTheExample() async throws {
    ...
    @Test(.requiresRscript) func cellContainsFallsBackToFileGranularityWithoutMarkers() async throws {
        let check = NotebookCheck(
    ...
    @Test(.requiresRscript) func figureCountCountsHighLevelPlots() async throws {
        let check = NotebookCheck(
    ...
    @Test(.requiresRscript) func figureCountIgnoresLowLevelAdditions() async throws {
        let check = NotebookCheck(
