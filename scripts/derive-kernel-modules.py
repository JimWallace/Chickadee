...
def main() -> None:
    ...
    out = {
        ...
        # Recorded because the stdlib list depends on it (see above), so a
        # surprising diff has a visible cause rather than looking like drift.
        "derivedOnPython": host_python,
        "kernelPython": env_python,
    }
