# Changelog — the 0.4 series and earlier (archived)

Release history for Chickadee 0.1.0 through 0.4.669, archived verbatim when
the 0.5.0 milestone split the changelog (the 0.4 file had reached ~13,500
lines). Current releases live in [CHANGELOG.md](CHANGELOG.md).
