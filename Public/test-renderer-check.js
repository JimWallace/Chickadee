...
(function (global) {
    ...
    function buildControl(field) {
        if (field.control === 'textarea') {
            var ta = el('textarea', { 'class': 'form-input input-compact input-mono', 'data-field': field.name, rows: String(field.rows || 4) });
            if (field.placeholder) ta.placeholder = field.placeholder;
            return ta;
        }
        if (field.control === 'select') {
            var sel = el('select', { 'class': 'form-input input-compact', 'data-field': field.name });
        ...
        var input = el('input', {
            ...
            'class': 'form-input input-compact', 'data-field': field.name
        });
    ...
    var renderer = {
        ...
        mount: function (bodyEl /*, ctx */) {
            ...
            nameInput = el('input', { type: 'text', 'class': 'form-input input-compact', placeholder: '(auto-generated when blank)' });
            nameLabel.appendChild(nameInput);
            bodyEl.appendChild(nameLabel);

            var note = el('p', { 'class': 'card-meta' });
            ...
            Object.keys(schema.kinds).forEach(function (kind) {
                var card = el('div', { 'data-kind': kind, 'class': 'editor-stack' }, 'display:none');
